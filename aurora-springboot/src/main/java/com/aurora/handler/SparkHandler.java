...
import com.aurora.spark.bean.NettyGroup;
import com.aurora.spark.bean.ResultBean;
...
public class SparkHandler extends SimpleChannelInboundHandler<TextWebSocketFrame> {

    private Logger log = LoggerFactory.getLogger(SparkHandler.class);

    @Autowired
    private ResultBean.PushService pushService;
